...
bool FileTransferData::Initialize(const std::string & fileName, std::string & errMsg)
{
	...
	{
		errMsg = "Server say: File Transfer already in progress. File Transfer Request denied.";
		return false;
	}
